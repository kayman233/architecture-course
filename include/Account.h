...
public:
    Debit(uint32_t id, uint32_t clientId, uint32_t bankId, int64_t balance, float percent)
        : Account(id, clientId, bankId, balance), percent(percent) {}
...
public:
    ...
    Credit(uint32_t id, uint32_t clientId, uint32_t bankId, int64_t balance, float commision)
        : Account(id, clientId, bankId, balance), commision(commision) {}
